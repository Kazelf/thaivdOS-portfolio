    ...
    <div className="grid grid-cols-12 h-full min-h-0">
      <div className="side-bar col-span-3 flex flex-col min-h-0 p-3 bg-base border-r border-r-base-300">
                ...
                renderItem={(game) => (
                  <>
                    {game.cover ? (
                      ...
                      <div className="h-full aspect-square flex-center rounded-sm bg-base-300 text-[10px] font-bold">
                        {key.toUpperCase()}
                      </div>
                    )}
        ...
        <button
          ...
          className="flex-center gap-2 mt-3 px-3 py-2 text-sm rounded-lg bg-base-300 hover:bg-primary/30 cursor-pointer"
        >
      ...
      <div className="col-span-9 min-h-0 flex flex-col">
        {playing ? (
          <>
            <div className="flex items-center gap-2 px-3 py-2 border-b border-b-base-300">
              <button
                onClick={() => setPlaying(null)}
                className="p-1 rounded-md hover:bg-base-300 cursor-pointer"
          ...
          selected && (
            <div className="flex-1 min-h-0 overflow-y-auto p-6 flex flex-col gap-5">
              <div className="w-full aspect-video rounded-xl overflow-hidden bg-black flex-center">
                {selected.cover ? (
                  <img
                    src={selected.cover}
                    alt={selected.name}
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <button
                  ...
                  className={clsx(
                    ...
                    "bg-primary text-primary-foreground hover:bg-primary-200",
                  )}
                >
              ...
              <div className="text-sm opacity-80 space-y-1">
                <p>
                  Controls: Arrow keys · Z / X (A / B) · Enter (Start) · V
                  (Select) · Q / E (L / R). Change them in the emulator menu.
                </p>
                {selected.license && (
...
const SteamWindow = WindowWrapper(Steam, "steam", {
  title: "Steam",
  windowClassName: "window w-5xl h-[80vh]",
});
